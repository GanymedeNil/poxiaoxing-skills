...
- Comment collection prints progress to stderr, including target/output path, browser readiness, each top-level comment page request/result, each reply page request/result, and the final saved summary.
